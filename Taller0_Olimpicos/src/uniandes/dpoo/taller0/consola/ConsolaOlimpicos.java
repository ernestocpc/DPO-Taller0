...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. MODIFICACION: Pais al que representa el atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 * Le muestra al usuario el nombre del pais al cual representa el atleta
	 */
	private void ejecutarNombrePais() {
		...
		Pais pais = calculadora.paisDeAtleta(atleta);
		String result = pais.darNombre();
		System.out.println("El nombre del pais del atleta es: " + result);
